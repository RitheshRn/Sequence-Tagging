...
#         print(self.emission['BACKGROUND'])
    ...
    def transition_papameters(self, gamma=0.1):
...
#         for ngram in self.ngram_counts[2]:
#             self.transition[ngram] = (self.ngram_counts[2][ngram] + gamma)/ (self.ngram_counts[1][(ngram[0], ngram[1])]+(gamma*2) )
        with open('transition.out','w') as f:
            for i in self.transition:
                f.write(str((i, self.transition[i]))+"\n")

        
    def Viterbi_algorithm(self, magic=6):
        S = defaultdict(list)
        S[-1] = ['*']
        S[0] = ['*']
...
#                                 for tag, vval in self.emission['_NUMERIC_']:
#                                     if tag == v:
#                                         temp_emission = vval
#                             elif sentence[k-1].isupper():
#                                 for tag, vval in self.emission['_UPPER_']:
#                                     if tag == v:
#                                         temp_emission = vval
                                        
#                             elif sentence[k-1] in "~!@#$%^&*()__+={}[]|.;":
#                                 for tag, vval in self.emission['_SPL_']:
#                                     if tag == v:
#                                         temp_emission = vval
                            
#                             elif sentence[k-1] == sentence[k-1].upper():
#                                 for tag, vval in self.emission['_CAPS_']:
#                                     if tag == v:
#                                         temp_emission = vval
#                             elif sentence[k-1][0] == sentence[k-1][0].upper():
#                                 for tag, vval in self.emission['_initCAPS_']:
#                                     if tag == v:
#                                         temp_emission = vval
#                             elif len(sentence[k-1]) > int(magic):
#                                 for tag, vval in self.emission['_LEN_']:
#                                     if tag == v:
#                                         temp_emission = vval
                            else:
